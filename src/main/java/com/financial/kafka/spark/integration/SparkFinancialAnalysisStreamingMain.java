...
import org.apache.spark.sql.execution.aggregate.ObjectAggregationIterator;
           ...
           // Flag to indicate if at least some records have been received and aggregated
            ...
            try{
                ...
                if(isAggregatedDataAvailable) {
                    ...
                    // Read loan data stats from Parquet Files for each micro-batch and combine them for aggregated results
